...
module Amber::Schema
  ...
  module ControllerIntegration
    ...
    def respond_with(data : Hash(String, JSON::Any) | NamedTuple | Nil = nil, status : Int32 = 200, schema_name : String? = nil)
      respond_with_schema(data, status, schema_name)
    end

    def respond_with_schema(data : Hash(String, JSON::Any) | NamedTuple | Nil = nil, status : Int32 = 200, schema_name : String? = nil)
